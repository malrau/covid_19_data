...
```{r, echo=FALSE}
ymarks <- c(10000,40000,80000,120000,160000,200000,240000,280000)
ylabels <- c("10","40","80","120","160","200","240","280")
xmarks <- date[c(1,21,82,143,205,266,289)] #,"2020-12-15"
xlabels <- c("24 Feb","15 Mar","15 Mag","15 Lug","15 Set","15 Nov","08 Dic")

par(bg="#EAF2F3")
plot(c(0,tamponi_ita)~date,type="l",xaxt="n",yaxt="n",xlab="",ylab="",bty="n",main="Tamponi giornalieri")
...
hist(diff(tamponi_matrix)[15,2:22])
...
quota_positivi_centro <- rowSums(matrix(diff(covid_data$totale_casi)/diff(covid_data$tamponi),ncol=22)[,9:12])
quota_positivi_sud <- rowSums(matrix(diff(covid_data$totale_casi)/diff(covid_data$tamponi),ncol=22)[,13:20])
