...
setwd("~/github/covid_19_data/dataset")
covid_ita1 <- read.delim("COVID-19-master/dati-andamento-nazionale/dpc-covid19-ita-andamento-nazionale.csv",sep=",",header=T) #This is the file containing the data for the whole country. I use it as data frame
...
covid_reg1 <- read.delim("COVID-19-master/dati-regioni/dpc-covid19-ita-regioni.csv",sep=",",header=T) #Here I load the regional data frame. I already know I have to substitute the date variable with the one in date format.
...
write.csv(covid_data,"github/covid_19_data/covid_data.csv") #I save the dataframe as a .csv file
############################
############################
############################
