...
#plot totale casi
marks <- c(100000,250000,450000,600000)
plot(totale_casi_nord~date,type="l",col="blue",main="Totale casi da coronavirus COVID-19 in Italia \n(per aree geografiche)",cex.main=.9,xlab="",ylab="",yaxt="n")
axis(2,at=marks,labels=marks,las=2)
lines(totale_casi_centro~date,col="green")
lines(totale_casi_sud~date,col="orange")

#plot nuovi positivi
marks2 <- c(5000,15000,25000)
plot(nuovi_positivi_nord~date,type="l",col="blue",main="Nuovi positivi al coronavirus COVID-19 in Italia \n(per aree geografiche)",cex.main=.9,xlab="",ylab="",yaxt="n")
axis(2,at=marks2,labels=marks2,las=2)
...
plot(totale_casi_nord[1:30]~date[1:30],type="l",col="blue",xlab="",ylab="")
...
```{r, echo=FALSE}
x <- seq(1,45,1)
plot(totale_casi_nord[1:45]~date[1:45],type="l",col="blue",xlab="",ylab="")
